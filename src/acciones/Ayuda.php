    ...
    public function retorno(string $id_chat): ObjetoResponse
    {
        if ($this->parametro == "personajes") {
            ...
            $array_ayuda = [
                ...
                "/personajes [NOMBRE_PERSONAJE] [NUMERO_ESTRELLAS] [-e]: devolverá información de dicho personaje. Se puede buscar %[TROZO_NOMBRE_PERSONAJE] y devolverá solo los coincidentes, si solo devuelve uno será como si lo hubieramos buscado con el nombre completo, pudiendo añadir el número de estrellas.
El número de estrellas es opcional. Puede ir de 0 a 7. Indicando 0 mostrará quien no tiene al personaje desbloqueado, sinó mostrará los que lo tengan con esa cantidad de estrellas o más.
-e: mostrá más info aparte del jugador que lo tenga (nivel, pg, estrellas, gear, zetas)",
                ...
                "/naves o /nave o /n: devolverá un listado de naves posibles. Se aplican los mismos parámetros que para personajes",
